...
const Contact = () => {
  ...
  width="100%"
  height="100%"
  className="absolute inset-0 filter grayscale contrast-125 opacity-80 border-none overflow-hidden"
  title="map"
  src="https://maps.google.com/maps?width=100%&height=600&hl=en&q=Izmir&z=14&output=embed"
/>
            ...
            <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
              ...
              <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                ...
                <a
                  href="mailto:itxharoonkhan@gmail.com"
          ...
          <div className="lg:w-1/3 md:w-1/2  flex flex-col md:ml-auto w-full md:py-8 mt-8 md:mt-0">
            ...
            <div className="relative mb-4">
              ...
              <input
                ...
                id="name"
                name="name"
                className="w-full bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 text-base outline-none text-white py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
              />
            </div>
            <div className="relative mb-4">
